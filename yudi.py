...
#cl = LineClient()
cl = LineClient(authToken='u52f88b7d5e3aa166a94b3aa907588b37:aWF0OiAxNTU5NTg1NDQ4MDM2Cg==..S+DwbtiuxNe/Kkuif/8sFhgGLr0=')

#ki = LineClient()
ki = LineClient(authToken='u7111de85ba214ae3a2d37b810a60590e:aWF0OiAxNTU5NTg1MDEyODk2Cg==..BfO/PacTGr2NeTZHMr4OWZ66hX4=')

#kk = LineClient()
kk = LineClient(authToken='u286b991842b04c4b78cf91a0090d3c32:aWF0OiAxNTU5NTg1ODIzOTUxCg==..30yd0wdsG08j8bwEIEaVzu6sies=')

#kc = LineClient()
kc = LineClient(authToken='u4a6a851746cc48f3ce0b7d4c466e5861:aWF0OiAxNTU5NjY1MTE3MDQyCg==..ZiI6ULcORBq7JD3EzoFHltdiDx0=')

#kc = LineClient()
kb = LineClient(authToken='u946739f91721a022eb845b59b6644fb0:aWF0OiAxNTYwMTAyODk1MzM0Cg==..cpue5HxdtzLxoP7/1/AiEgEdjEQ=')

#kc = LineClient()
km = LineClient(authToken='u8cce9a4b482e25fbbed3b0e25f27fab7:aWF0OiAxNTU5NjY3MTQyNzcwCg==..LSgtyoI+hYTPwTmjpHVYfdMM8B8=')

#kc = LineClient()
kn = LineClient(authToken='u59aca7efeb0b49f8cb3e2696f3978261:aWF0OiAxNTYwMTAxNzg3MjMxCg==..IYeiFVo6GaeThle9xvBAz32uOCU=')

#sw = LineClient()
sw = LineClient(authToken='ud757e764d444bb8cf77e302f7c1dc2b3:aWF0OiAxNTU5NjY1NTU2NDIwCg==..aVLSzrFG4cRlY2F5Z6Dsxey9KwQ=')
...
KAC = [cl,ki,kk,kc,kb,km,kn]
ABC = [ki,kk,kc,kb,km,kn]
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     km.updateProfilePicture(path2)
                     km.sendMessage(msg.to, "Berhasil mengubah foto profile bot")
                     kn.updateProfilePicture(path3)
                        ...
                        if cmd == "help":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendContact(to, "u6b34b703cbc5fc83cd1e5b6832a05352")
                        ...
                        if cmd == "self on":
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "⏩UCHIHA Fams Grup Info\n\n⏩Nama Group : {}".format(G.name)+ "\n⏩ID Group : {}".format(G.id)+ "\n⏩Pembuat : {}".format(G.creator.displayName)+ "\n⏩Waktu Dibuat : {}".format(str(timeCreated))+ "\n⏩Jumlah Member : {}".format(str(len(G.members)))+ "\n⏩Jumlah Pending : {}".format(gPending)+ "\n⏩Group Qr : {}".format(gQr)+ "\n⏩Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                km.sendMessage(msg.to,responsename2)
                                kn.sendMessage(msg.to,responsename3)

                        elif cmd == "invitebot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    anggota = [Bmid,Cmid,Amid,Emid,Fmid,Dmid]
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "⏩UCHIHA Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
