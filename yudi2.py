...
#cl = LineClient()
cl = LineClient(authToken='uf05c4c93e4fdb447df91acd7785f28b2:aWF0OiAxNTYwMzI4Njk4Mjk4Cg==..8Di43gJPsPLxn5Ee6axCihPSrt8=')

#ki = LineClient()
ki = LineClient(authToken='u74c6334e56acbc9f515bf42fbdc883c2:aWF0OiAxNTYwMzMwNzc4NTk1Cg==..zXQeqs/aPR7m6c/LHH3lO2XybDU=')

#kk = LineClient()
kk = LineClient(authToken='u3cb40ed764ef8a68473d88eaab210e2c:aWF0OiAxNTYwMzMxMzM5NTg2Cg==..HZDllVvp2o/ss1DfCaJ5xeDwnko=')

#kc = LineClient()
kc = LineClient(authToken='ue802ae8a617eac14e70116766b1bc6f2:aWF0OiAxNTYwMzMxODg1OTc5Cg==..9bq75+mY25VPwX6w4Y/h6LOHbK4=')

#kc = LineClient()
kb = LineClient(authToken='u513700c52bf8431d9769ab34139f7302:aWF0OiAxNTYwMzM2ODU5OTAwCg==..PmkGJsULY2w3YM0N91hVAYNoZj0=')

#kc = LineClient()
km = LineClient(authToken='u945f1aaef8807a3d37e7e186e219e63f:aWF0OiAxNTYwMzM3MzU2MzE4Cg==..l1HMmj0Df4POncugkN5L8VkQlFQ=')

#kc = LineClient()
kn = LineClient(authToken='u9b1db04552ed7950159e7f31cf1e94c1:aWF0OiAxNTYwMzM3ODI4MDU4Cg==..nIWgCGlHS/yDhLoLeBAf23Rhx70=')

#sw = LineClient()
sw = LineClient(authToken='u3a69a8daa0f2ca0053b7da2f4fcda0ca:aWF0OiAxNTYwMzM5MjE3NDAxCg==..4JGsZi8Xz9cJ/qrhewoHrNdy92Y=')
